...
bool Session::chooseDecoder(StreamingPreferences::VideoDecoderSelection vds,
                            ...
                            bool enableVideoEnhancement, bool testOnly, int streamIndex,
                             ...
                             bool& isHdrSupported, QSize& maxResolution)
{
    ...
    if (chooseDecoder(StreamingPreferences::VDS_FORCE_HARDWARE,
                      ...
                      false, false, StreamingPreferences::get()->videoEnhancing, true, 0, decoder)) {
    ...
    if (chooseDecoder(StreamingPreferences::VDS_FORCE_HARDWARE,
        ...
        if (chooseDecoder(StreamingPreferences::VDS_FORCE_SOFTWARE,
                          window, VIDEO_FORMAT_H265_MAIN10, 1920, 1080, 60,
                          false, false, false, true, 0, decoder) ||
    ...
    if (chooseDecoder(StreamingPreferences::VDS_FORCE_HARDWARE,
                      ...
                      false, false, m_Preferences->videoEnhancing, true, 0, decoder)) {
        isHardwareAccelerated = decoder->isHardwareAccelerated();
        isFullScreenOnly = decoder->isAlwaysFullScreen();
        maxResolution = decoder->getDecoderMaxResolution();
        delete decoder;
                                ...
                                int videoFormat, int width, int height, int frameRate)
{
    ...
    if (!chooseDecoder(vds, window, videoFormat, width, height, frameRate, false, false, StreamingPreferences::get()->videoEnhancing, true, 0, decoder)) {
